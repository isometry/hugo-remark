/* PrismJS 1.16.0
https://prismjs.com/download.html#themes=prism-funky&languages=markup+css+clike+javascript+bash+diff+markup-templating+dns-zone-file+docker+git+go+graphql+hcl+http+ini+jq+json+markdown+django+nginx+sql+powershell+python+shell-session+yaml+tcl+toml+regex+vim+wiki+xquery&plugins=line-numbers+file-highlight+toolbar+copy-to-clipboard */
var _self =
